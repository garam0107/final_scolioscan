...
export function CameraGuidelineOverlay() {
  ...
  const insets = useSafeAreaInsets()
    ...
    const guideY = height - guideHeight - insets.bottom;


  return (
    <View style={{ ...styles.outlineWrap, width, height }} pointerEvents="none">
      <Svg width={width} height={height}>
        <Defs>
          ...
          >
            ...
            <G
              transform={`translate(${guideX}, ${guideY}) scale(${
                guideWidth / BASE_W
              }, ${guideHeight / BASE_H})`}
            >
        ...
        <Rect
          ...
          width={width}
          height={height}
          fill="rgba(75, 75, 80, 0.62)"
          mask="url(#camera-cutout)"
        />
      </Svg>

      <View style={[styles.outlineWrap, { left: guideX, top: guideY, width: guideWidth, height: guideHeight }]}>
